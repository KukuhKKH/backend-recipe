                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="flex-1 ps-3">
                                        <div class="mb-1"><small class="fs-9px fw-500 lh-1 d-inline-block rounded-0 badge bg-white bg-opacity-25 text-white text-opacity-75 pt-5px">SKU90400</small>
                                        </div>
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="d-flex fw-bold small mb-3">
                        ...
                        data-bs-original-title="" title=""><i class="bi bi-fullscreen"></i></a>
                    </div>
                    <div class="table-responsive">
